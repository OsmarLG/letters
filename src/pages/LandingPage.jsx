        ...
        <div className="landing-page">
            ...
            <div className="features">
                <div className="feature-card">
                    <h2>Personalizado</h2>
                    <p>Cartas y animaciones hechas a medida para tu historia.</p>
                </div>
                <div className="feature-card">
                    <h2>Interactivo</h2>
                    <p>Haz clic para abrir, ve crecer vuestro amor.</p>
                </div>
                <div className="feature-card">
                    <h2>Memorable</h2>
                    <p>Un regalo eterno que vive para siempre en la web.</p>
                </div>
            </div>
            ...
            <a
                ...
                className="whatsapp-float-landing"
                target="_blank"
                rel="noopener noreferrer"
            >
                <span className="whatsapp-label">¡Personaliza tu carta!</span>
